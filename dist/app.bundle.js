...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_core_js_fn_object_entries__ = __webpack_require__(43);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_core_js_fn_array_from__ = __webpack_require__(46);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_core_js_fn_array_find_index__ = __webpack_require__(63);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__css_style_css__ = __webpack_require__(70);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__gameController__ = __webpack_require__(71);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__cpuLogic__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__gameView__ = __webpack_require__(73);
...
var gameController = Object(__WEBPACK_IMPORTED_MODULE_5__gameController__["a" /* default */])();
var cpuLogic = Object(__WEBPACK_IMPORTED_MODULE_6__cpuLogic__["a" /* default */])(gameController);
var gameView = Object(__WEBPACK_IMPORTED_MODULE_7__gameView__["a" /* default */])(gameController);
...
var $export = __webpack_require__(3);
var $entries = __webpack_require__(45)(true);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_kute_js__ = __webpack_require__(30);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_kute_js_kute_svg__ = __webpack_require__(74);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__gamePrompts__ = __webpack_require__(75);
...
function GameView(controller) {
  return {
    ...
    getCurrentSquare: function getCurrentSquare(id) {
      var squaresArray = Array.from(this.squares);
      var targetIndex = squaresArray.findIndex(function (item) {
        return item.id == id;
      });
...
function GamePrompts(controller) {
  var coreProps = function coreProps(state) {
    ...
    var buttonEls = void 0,
        bindEvents = void 0;

    if (state.buttons === 1) {
      buttonEls = rootEl.querySelector("button"), bindEvents = function bindEvents() {
        buttonEls.addEventListener('click', state.handler);
      };
    } else if (state.buttons === 2) {
      buttonEls = rootEl.querySelectorAll("button"), bindEvents = function bindEvents() {
        var buttons = Array.from(buttonEls);
